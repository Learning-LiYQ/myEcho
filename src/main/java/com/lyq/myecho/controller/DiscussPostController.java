...
import com.lyq.myecho.service.LikeService;
import com.lyq.myecho.service.UserService;
import com.lyq.myecho.util.*;
...
public class DiscussPostController implements CommunityConstant {
    ...
    public String uploadMdPic(@RequestParam(value = "editormd-image-file", required = false) MultipartFile file) {
        ...
        try {
            ...
            url = "http://" + qiNiuYunUtil.uploadQiniuYun(inputStream);
            try {
                //延迟两秒让七牛云缓一下
                Thread.sleep(2000);
...
//        }
    ...
    public String addDiscussPost(String title, String content) {
        if (StringUtils.isBlank(title)) {
            return CommunityUtil.getJSONString(403, "标题不得为空");
        }
